...
export default function ModalExample() {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center pt-11" data-aos="zoom-in">
      <button className="bg-red-700 hover:bg-blue-700 px-4 py-3 hover:scale-110 duration-300 text-gray-100 rounded-lg shadow-lg" onClick={handleShow}>
        Launch demo modal
      </button>

      <Modal show={show} onHide={handleClose} className="bg-gray-950 bg-opacity-25">
        <Modal.Header closeButton className="dark:bg-gray-600 dark:text-gray-200">
          <Modal.Title>Modal heading</Modal.Title>
        </Modal.Header>
        <Modal.Body className="dark:bg-gray-600 dark:text-gray-200">Woohoo, you are reading this text in a modal!</Modal.Body>
        <Modal.Footer className="dark:bg-gray-600 dark:text-gray-200">
          <button className="shadow-lg bg-red-700 hover:bg-blue-700 px-4 py-2 duration-300 text-gray-100 rounded-lg" onClick={handleClose}>
            Close
          </button>
        </Modal.Footer>
      </Modal>
